...
int main(int argc, char **argv) {
  ...
  ClientPool<ThriftClient<BeveragePreferenceServiceClient>> beverage_preference_client_pool("beverage-preference-service", beverage_preference_service_addr, beverage_preference_service_port, 0, 128, 1000);
